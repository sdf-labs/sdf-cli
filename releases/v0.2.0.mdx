...
as needed:
- [Migrate from 0.1.x to 0.2.x](../releases/migrations/1.1-1.2)
...
reference the [New Provider Configuration](../releases/migrations/1.1-1.2#new-provider-configuration).
