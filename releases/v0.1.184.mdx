...
and [AWS & Redshift Integration](/integrations/redshift).
...
to be extended with column-level lineage, code contracts, and data classifications/governance.
...
SDF supports the use of code contracts in CI/CD. This feature allows users to define their own static tests, further 
...
This new [CI/CD Guide](/guide/ci_cd) will walk you through how to integrate SDF into an example CI/CD workflow with GitHub Actions to 
...
### New Docs!
- [CI/CD Guide](/guide/ci_cd)
- [Indexing Guide](/guide/index)
- [Snowflake Integration](/integrations/snowflake)
- [AWS & Redshift Integration](/integrations/redshift)
