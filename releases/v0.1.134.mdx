...
| ---------------------- | ------ | ------- | -------- |
| Linux Intel X86-64     |   ✅   | 0.1.134  | [Download](https://cdn.sdf.com/releases/download/sdf-v0.1.134-x86_64-unknown-linux-musl.tar.gz) |
| Linux Arm ARM-64       |   ✅   | 0.1.134  | [Download](https://cdn.sdf.com/releases/download/sdf-v0.1.134-arm-unknown-linux-gnueabihf.tar.gz) |
| Apple Intel X86-64     |   ✅   | 0.1.134  | [Download](https://cdn.sdf.com/releases/download/sdf-v0.1.134-x86_64-apple-darwin.tar.gz) |
| Apple Arm AARCh-64     |   ✅   | 0.1.134  | [Download](https://cdn.sdf.com/releases/download/sdf-v0.1.134-aarch64-apple-darwin.tar.gz) |
