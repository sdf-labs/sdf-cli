...
``` shell 
    Created lineage2/checks/check_sink_phone_is_pii.sql
    Created lineage2/src/knis.sql
    Created lineage2/src/middle.sql
    Created lineage2/src/sink.sql
    Created lineage2/src/source.sql
    Created lineage2/workspace.sdf.yml
