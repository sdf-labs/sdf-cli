...
Working set 1 report file, 1 .sdf file
  Reporting sdf.reports.tables_with_pii (./reports/tables_with_pii.sql)
   Finished 12 models [12 succeeded], 1 code-report [1 succeeded] in 1.604 secs
...
Working set 1 report file, 1 .sdf file
  Reporting sdf.reports.tables_with_pii (./reports/tables_with_pii.sql)
   Finished 12 models [12 reused], 1 code-report [1 succeeded] in 0.906 secs
...
Working set 2 report files, 1 .sdf file
  Reporting sdf.reports.pii_datatypes (./reports/pii_datatypes.sql)
   Finished 12 models [12 reused], 2 code-reports [1 succeeded, 1 reused] in 0.924 secs
