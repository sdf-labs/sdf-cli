...
Working set 12 model files, 1 report file, 3 .sdf files
  ...
  Reporting sdf.reports.tables_with_pii (./reports/tables_with_pii.sql)
   Finished 12 models, 1 report in 0.638 secs
...
Working set 12 model files, 1 report file, 3 .sdf files
  Reporting sdf.reports.tables_with_pii (./reports/tables_with_pii.sql)
   Finished 12 models, 1 report in 0.587 secs
...
Working set 12 model files, 2 report files, 3 .sdf files
  ...
  Reporting sdf.reports.pii_datatypes (./reports/pii_datatypes.sql)
   Finished 12 models, 2 reports in 0.644 secs
