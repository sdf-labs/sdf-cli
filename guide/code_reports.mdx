...
```shell
Working set 12 model, 1 report, 3 sdf files
  ...
  Reporting sdf.reports.tables_with_pii (./reports/tables_with_pii.sql)
   Finished 12 models, 1 report in 0.585 secs
...
Working set 12 model, 1 report, 3 sdf files
  Reporting sdf.reports.tables_with_pii (./reports/tables_with_pii.sql)
   Finished 12 models, 1 report in 0.555 secs
...
```
  ...
  <Step title="Add a New Code Report">
    ...
    ```
```shell
Working set 12 model, 2 report, 3 sdf files
  Reporting sdf.reports.pii_datatypes (./reports/pii_datatypes.sql)
  Reporting sdf.reports.tables_with_pii (./reports/tables_with_pii.sql)
   Finished 12 models, 2 reports in 0.557 secs
