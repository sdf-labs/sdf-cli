...
+----------------------------------------------+-------------------------+-----------+
4 rows.
   Finished 14 models [12 succeeded, 2 reused], 1 report [1 succeeded] in 1.836 secs
...
+----------------------------------------------+--------------+-------------------------+-----------+
7 rows.
   Finished 14 models [14 reused], 1 report [1 succeeded] in 1.071 secs
...
+-----------+-----------+
1 rows.
   Finished 14 models [14 reused], 2 reports [1 succeeded, 1 reused] in 1.087 secs
