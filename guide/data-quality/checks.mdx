...
[Pass] Check hello.pub.code_check
   Finished 2 models [1 succeeded, 1 reused], 1 check [1 passed] in 1.293 secs
...
+----------------+-------------+-------------+
1 rows.
   Finished 2 models [1 succeeded, 1 reused], 1 check [1 failed] in 1.295 secs, for details see below.

-------
Summary 2 models [1 succeeded, 1 reused], 1 check [1 failed] in 1.295 secs.
-------
