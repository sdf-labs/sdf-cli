...
<Steps>
    ...
    <Step title="Add a Single Compiled Query">
		...
		includes:
            ...
            default-schema: <default_schema_for_this_query>
            default-catalog: <default_catalog_for_this_query>
		```   
    ...
    <Step title="Add a Full Directory">
		...
		includes:
            ...
            default-catalog: <default_catalog_for_this_directory>
