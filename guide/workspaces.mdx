...
- What Code Checks should run
- The Schema and Catalog defaults
- Which classifiers exist and what columns they should be attached to
- And more...
...
Here's an example of a full-fledged table definition generated in an assembly yml:
