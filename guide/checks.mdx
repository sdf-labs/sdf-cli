...
Working set 1 test file, 1 .sdf file
   ...
   Finished 1 model [1 succeeded], 1 check [1 passed] in 0.726 secs
...
Working set 1 test file, 1 .sdf file
    Testing hello.pub.code_check (./checks/code_check.sql)
   Finished 1 model [1 succeeded], 1 check [1 failed] in 0.733 secs, for details see below.
...
-------
Summary 1 model [1 succeeded], 1 check [1 failed] in 0.733 secs.
-------
