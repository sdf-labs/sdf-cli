...
[Pass] Check hello.pub.code_check
   Finished 2 models [1 succeeded, 1 reused], 1 check [1 passed] in 0.720 secs
...
+----------------+-------------+-------------+
1 rows.
   Finished 2 models [1 succeeded, 1 reused], 1 check [1 failed] in 0.718 secs, for details see below.

-------
Summary 2 models [1 succeeded, 1 reused], 1 check [1 failed] in 0.718 secs.
-------
