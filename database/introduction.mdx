...
a sophisticated cacheing layer that fingerprints data, code, metadata to optimally recompute nodes that are out of date after any given change. 
...
<Tip>
SDF DB is in alpha with breaking changes, new functinality, and more coming all the time. If you are interested in using the database product, please contact us.
</Tip>
