...
## array
```sql
function array($1, ...) returns +list<$1>
```


## array_flatten
```sql
function array_flatten(+list<list<$1>>) returns +list<$1>
```
...
## split_to_array
```sql
function split_to_array(varchar, varchar) returns +list<varchar>
```
...
## subarray
```sql
function subarray(+list<$1>, bigint, bigint) returns +list<$1>
```
