...
`targets:` | `array`| Targets define input and output locations for artifacts read and written by the workspace|
`defaults:` | `Defaults?`| Defaults for this workspace|
`dialect:` | `UNKNOWN`| undefined|
...
`purpose:` | `TablePurpose?`| undefined|
...
|Field | Type | Description|
| :---- | :--- | :------- |
`target:` | `string?`| The default target (can only be set on the level of the workspace/profile)|
...
`index:` | `IndexMethod?`| The default index for this tables tests and checks|
`severity:` | `Severity?`| The default severity for this tables tests and checks|
...
`default-schema:` | `string`| Defines a default schema (If not set, defaults to 'pub')|
`dependencies:` | `array`| Dependencies of the workspace to other workspaces or to cloud database providers|
`targets:` | `array`| Targets define input and output locations for artifacts read and written by the profile|
