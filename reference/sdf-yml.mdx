...
`managed` | A managed table is managed by an external table provider like Iceberg, Glue, etc|
...
|Field | Type | Description|
| :---- | :--- | :------- |
### Nested element: `TableProvider`
|Field | Type | Description|
| :---- | :--- | :------- |
`catalog:` | `string`| The catalog name of the catalog [e.g.: database]|
