...
`system` | System tables are not materialized|
`catalog` | Catalog tables are not materialized|
...
`access-with:` | `AccessMethod?`| Last modified of the file|
### Nested element: `Dialect`
|Field | Type | Description|
| :---- | :--- | :------- |
### Nested element: `AccessMethod`
|Field | Type | Description|
| :---- | :--- | :------- |
...
|Field | Type | Description|
| :---- | :--- | :------- |
`name:` | `string`| The name of the catalog [e.g.: database]|
