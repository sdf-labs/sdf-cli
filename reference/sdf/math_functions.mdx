...
## abs
```sql
function abs(+decimal<$1, $2>) returns +decimal<$1, $2>
```
...
## acos
```sql
function acos(+fp64) returns +fp64
```
...
## asin
```sql
function asin(+fp64) returns +fp64
```
...
## atan
```sql
function atan(+fp64) returns +fp64
```
...
## atan2
```sql
function atan2(+fp64, +fp64) returns +fp64
```
...
## cos
```sql
function cos(+fp64) returns +fp64
```
...
## exp
```sql
function exp(+fp64) returns +fp64
```
...
## floor
```sql
function floor(+i64) returns +i64
```
...
## log10
```sql
function log10(+fp64) returns +fp64
```
...
## log2
```sql
function log2(+fp64) returns +fp64
```
...
## power
```sql
function power(+fp64, +fp64) returns +fp64
```
...
## round
```sql
function round(+i64) returns +i64
```
...
## signum
```sql
function signum(x +fp64) returns +fp64
```
...
## sin
```sql
function sin(+fp64) returns +fp64
```
...
## sqrt
```sql
function sqrt(+fp64) returns +fp64
```
...
## tan
```sql
function tan(+fp64) returns +fp64
```
...
## trunc
```sql
function trunc(x +fp64) returns +fp64
```
