...
* `--no-save` — Don't save table data for caching

  Default value: `false`
* `--no-cache` — Don't read cached table data
...
* `--no-save` — Don't save table schema for caching

  Default value: `false`
* `--no-cache` — Don't read cached table schema
