...
```sql
function max_by(<$1, $1>) returns $1
```
Returns value of first column with maximum second column val

```sql
function max_by(<$1, $1, decimal(38, 0)>) returns array
```
Returns value of first column with maximum second column val
...
```sql
function min_by(<$1, $1>) returns $1
```
Returns value of first column with minimum second column val

```sql
function min_by(<$1, $1, decimal(38, 0)>) returns array
```
Returns value of first column with minimum second column val
