...
```sql
function classifier(<>) returns varchar
```
...
```sql
function match_number(<>) returns int
```
...
```sql
function match_sequence_number(<>) returns int
```
