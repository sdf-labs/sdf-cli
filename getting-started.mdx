...
+-------------+-----------+-------------+------------+
    ...
    Written .sdfcache/dbg/information_schema.sql
    Written .sdfcache/dbg/sdf.information_schema.tables
    Written .sdfcache/dbg/sdf.information_schema.columns

CodeChecks 
   [Pass] not exists code_check (checks/code_check.sql)
   Finished describe in 0.078 secs
