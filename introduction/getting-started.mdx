...
+-------------+------------------+------------+
   Finished 1 model [1 succeeded] in 0.179 secs
...
+----------+-----------------+
1 rows.
   Finished 1 model [1 succeeded] in 0.166 secs
...
└──────┐
       main.column_1
   Finished 2 models [2 succeeded] in 0.172 secs
