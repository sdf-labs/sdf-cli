...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
  Compiling sdf_snowflake.staging.latest_repo_name (./src/sdf_snowflake/staging/latest_repo_name.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 2.131 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
   ...
   Finished 2 models [1 succeeded, 1 downloaded] in 7.575 secs

Table sdf_snowflake.staging.latest_repo_name
+------------------------------------+-----------+
| repo_name                          | repo_id   |
+------------------------------------+-----------+
| Munyivacarol/python-p3-sql-queries | 813612693 |
| mahamaya-mishra/DSA-GFG            | 802206645 |
| feronando/arcade                   | 813600527 |
| basavaraj8767/Demo8548             | 813629106 |
| maffblaster/eselect-repository     | 609316815 |
| ChristopherTille/XAI_EyeTracking   | 813496481 |
| amrish1255/Chats                   | 813436387 |
| thelehcmut/project0                | 813738463 |
| MMMA911/FSGS                       | 813415614 |
| Q0LT/vuln_exploit                  | 813681147 |
+------------------------------------+-----------+
10 rows.
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  Compiling sdf_snowflake.staging.push_events (./src/sdf_snowflake/staging/push_events.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 2.240 secs
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (./src/sdf_snowflake/cybersyn_tech_innovation/events_by_repo.sql)
   Finished 13 models [6 succeeded, 7 downloaded] in 2.142 secs
