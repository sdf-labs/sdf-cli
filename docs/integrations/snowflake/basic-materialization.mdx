...
Downloading tech__innovation_essentials.cybersyn.domain_characteristics (schema)
  Compiling sdf_snowflake.cybersyn_tech_innovation.active_ai_domains (./src/sdf_snowflake/cybersyn_tech_innovation/active_ai_domains.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 1.975 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
  Compiling sdf_snowflake.staging.latest_repo_name (./src/sdf_snowflake/staging/latest_repo_name.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 1.924 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
   ...
   Finished 2 models [1 succeeded, 1 downloaded] in 5.642 secs

Table sdf_snowflake.staging.latest_repo_name
┌───────────────────────────────────────────────────────┬───────────┐
│ repo_name                                             ┆ repo_id   │
╞═══════════════════════════════════════════════════════╪═══════════╡
│ aarush-30/crypto-tracker                              ┆ 817715306 │
│ RehanAdilAbbasiRAA/Machine-Learning-and-Model-traning ┆ 817734603 │
│ PauloCesar-Souza/dio-bd-relacional                    ┆ 817546330 │
│ eryk-fernandes/eryk-fernandes                         ┆ 817994287 │
│ KEIO-SLC-SOFTTENNIS/keio_slc_softtennis.github.io     ┆ 816542708 │
│ Gabrielam0305/Examen2_RolandoyGabriela                ┆ 817610950 │
│ TxmMinh/App-stock-prediction                          ┆ 817829886 │
│ chrisfullpw/sistema-de-registro                       ┆ 817615932 │
│ BilvikaMellamputi/chatbot                             ┆ 817556818 │
│ Eamanisrilakshmi/Srilakshmi06                         ┆ 817733564 │
└───────────────────────────────────────────────────────┴───────────┘
10 rows.
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  Compiling sdf_snowflake.staging.push_events (./src/sdf_snowflake/staging/push_events.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 1.958 secs
...
Downloading tech__innovation_essentials.cybersyn.domain_characteristics (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (./src/sdf_snowflake/cybersyn_tech_innovation/events_by_repo.sql)
   Finished 13 models [6 succeeded, 7 downloaded] in 2.634 secs
