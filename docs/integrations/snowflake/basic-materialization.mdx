...
Downloading tech__innovation_essentials.cybersyn.domain_characteristics (schema)
  Compiling sdf_snowflake.cybersyn_tech_innovation.active_ai_domains (./src/sdf_snowflake/cybersyn_tech_innovation/active_ai_domains.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 1.707 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
  Compiling sdf_snowflake.staging.latest_repo_name (./src/sdf_snowflake/staging/latest_repo_name.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 1.611 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
   ...
   Finished 2 models [1 succeeded, 1 downloaded] in 7.107 secs

Table sdf_snowflake.staging.latest_repo_name
+-------------------------------------------------------------------------------------+-----------+
| repo_name                                                                           | repo_id   |
+-------------------------------------------------------------------------------------+-----------+
| sajjadkazmi/News-Blog                                                               | 808782084 |
| arynnaggarwal/Virtual_Mouse_and_Voice_Assistance                                    | 808792992 |
| amiruchis/MI2022                                                                    | 808661971 |
| pratiksha-shikhare/budget_buddy                                                     | 808566279 |
| MetadataGitTesting/KSlK9J7x                                                         | 808709975 |
| DeLuna-MartDexter-BSIT32E1/PREFINAL_ASSIGNMENT_TWO_POKEMON_DE-LUNA_DEXTER_BSIT_32E1 | 808682281 |
| DonchoLozev/Arena-Game                                                              | 808602242 |
| masanov3167/taxi-test                                                               | 808411555 |
| johndept22/drgfdhfh                                                                 | 808522112 |
| Rastanan17/Sanguchito                                                               | 808793473 |
+-------------------------------------------------------------------------------------+-----------+
10 rows.
...
Downloading tech__innovation_essentials.cybersyn.github_stars (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (./src/sdf_snowflake/cybersyn_tech_innovation/events_by_repo.sql)
   Finished 13 models [6 succeeded, 7 downloaded] in 1.939 secs
