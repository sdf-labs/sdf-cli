...
``` shell
    ...
    Created cybersyn_tech_innovation/.sdfcache/dbg/compiled-files/src/sdf_snowflake/cybersyn_tech_innovation/most_starred_repos.sql
    Created cybersyn_tech_innovation/.sdfcache/dbg/compiled-queries/sdf_snowflake/cybersyn_tech_innovation/most_starred_repos.sql
    Created cybersyn_tech_innovation/.sdfcache/dbg/data/tech__innovation_essentials/cybersyn/github_repos/data_0.parquet
    Created cybersyn_tech_innovation/.sdfcache/dbg/data/tech__innovation_essentials/cybersyn/github_stars/data_0.parquet
    Created cybersyn_tech_innovation/.sdfcache/dbg/std/.gitignore
    Created cybersyn_tech_innovation/.sdfcache/dbg/std/macros/generate_date_values.jinja
    Created cybersyn_tech_innovation/.sdfcache/dbg/std/macros/generate_integer_values.jinja
    Created cybersyn_tech_innovation/.sdfcache/dbg/std/macros/materialize.jinja
    Created cybersyn_tech_innovation/.sdfcache/dbg/std/macros/star.jinja
    Created cybersyn_tech_innovation/.sdfcache/dbg/std/macros/surrogate_key.jinja
    Created cybersyn_tech_innovation/.sdfcache/dbg/std/macros/test.jinja
    Created cybersyn_tech_innovation/.sdfcache/dbg/std/workspace.sdf.yml
    Created cybersyn_tech_innovation/.sdfcache/dbg/table/tech__innovation_essentials/cybersyn/github_repos.sdf.yml
    Created cybersyn_tech_innovation/.sdfcache/dbg/table/tech__innovation_essentials/cybersyn/github_stars.sdf.yml
...
Downloading tech__innovation_essentials.cybersyn.domain_characteristics (schema)
  Compiling sdf_snowflake.cybersyn_tech_innovation.active_ai_domains (./src/sdf_snowflake/cybersyn_tech_innovation/active_ai_domains.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 2.082 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
  Compiling sdf_snowflake.staging.latest_repo_name (./src/sdf_snowflake/staging/latest_repo_name.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 2.402 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
   ...
   Finished 2 models [1 succeeded, 1 downloaded] in 6.006 secs

Table sdf_snowflake.staging.latest_repo_name
+----------------------------------------------+-----------+
| repo_name                                    | repo_id   |
+----------------------------------------------+-----------+
| MayCleanSitepu/rest-api-express-prisma       | 810247313 |
| beazinat/variaveis-operadores-java-gen       | 810429805 |
| theoafactor/microkafka                       | 810253417 |
| MetadataGitTesting/some-random-repo-jPSn7mfR | 810346317 |
| Stingr4y/webflyx                             | 810442982 |
| Createbot7/Demon                             | 810426476 |
| XanderLouis/Fixing-the-Bank-Churning-Problem | 810102037 |
| Blitzkrieg7a/financial-dashboard             | 810432670 |
| lyj0829/lyj0829                              | 810081742 |
| PING-An32/blog                               | 810128297 |
+----------------------------------------------+-----------+
10 rows.
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  Compiling sdf_snowflake.staging.push_events (./src/sdf_snowflake/staging/push_events.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 3.734 secs
...
Downloading tech__innovation_essentials.cybersyn.uspto_patent_contributor_relationships (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (./src/sdf_snowflake/cybersyn_tech_innovation/events_by_repo.sql)
   Finished 13 models [6 succeeded, 7 downloaded] in 2.120 secs
