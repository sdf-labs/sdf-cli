...
Downloading tech__innovation_essentials.cybersyn.domain_characteristics (schema)
  Compiling sdf_snowflake.cybersyn_tech_innovation.active_ai_domains (./src/sdf_snowflake/cybersyn_tech_innovation/active_ai_domains.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 1.585 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
   ...
   Finished 2 models [1 succeeded, 1 downloaded] in 5.635 secs

Table sdf_snowflake.staging.latest_repo_name
+-------------------------------------+-----------+
| repo_name                           | repo_id   |
+-------------------------------------+-----------+
| MrRaven55/SkillTree                 | 795375558 |
| ilocodes/first-contributions        | 807753048 |
| Myhgan/FoodDelivery                 | 807586898 |
| liaoyann/ceaser.github.io           | 807531016 |
| Unberger/PP_1_1_3-4                 | 807462891 |
| ericahribeiro/puplic_knowledge_base | 807843388 |
| Srujanakongoti/webdevop             | 807529980 |
| clandesv/portfolio                  | 807058042 |
| wilson432/Navigation                | 807831903 |
| hadinata08/contact-management       | 807509905 |
+-------------------------------------+-----------+
10 rows.
...
Downloading tech__innovation_essentials.cybersyn.uspto_patent_index (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (./src/sdf_snowflake/cybersyn_tech_innovation/events_by_repo.sql)
   Finished 13 models [6 succeeded, 7 downloaded] in 1.609 secs
