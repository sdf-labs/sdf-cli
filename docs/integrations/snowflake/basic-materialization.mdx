...
Downloading tech__innovation_essentials.cybersyn.domain_characteristics (schema)
  Compiling sdf_snowflake.cybersyn_tech_innovation.active_ai_domains (./src/sdf_snowflake/cybersyn_tech_innovation/active_ai_domains.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 1.534 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
  Compiling sdf_snowflake.staging.latest_repo_name (./src/sdf_snowflake/staging/latest_repo_name.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 1.520 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
   ...
   Finished 2 models [1 succeeded, 1 downloaded] in 6.235 secs

Table sdf_snowflake.staging.latest_repo_name
+-----------------------------------------------------------------+-----------+
| repo_name                                                       | repo_id   |
+-----------------------------------------------------------------+-----------+
| abdsarmai/IP-SRV-WEB                                            | 808530445 |
| fenhrir93/kanban                                                | 808516148 |
| floratech01/Employee-Retention-Prediction                       | 808599725 |
| vanita6070/SA-Maven-Web-App-Vanita                              | 808564614 |
| tejalmeshram27/CoursePortal                                     | 808551792 |
| RaghibAbdien/titian_crew                                        | 808508115 |
| static-web-apps-testing-org/swa3cea078b76224ba693a01d97702c02a1 | 808797056 |
| Roman-179/https---github.com-Roman-179-agon                     | 808593638 |
| hurriCase/faceid-2-exercism                                     | 808626480 |
| NicoRozier/skills-introduction-to-github                        | 808540121 |
+-----------------------------------------------------------------+-----------+
10 rows.
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  Compiling sdf_snowflake.staging.push_events (./src/sdf_snowflake/staging/push_events.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 1.496 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (./src/sdf_snowflake/cybersyn_tech_innovation/events_by_repo.sql)
   Finished 13 models [6 succeeded, 7 downloaded] in 1.569 secs
