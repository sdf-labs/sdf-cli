...
Downloading tech__innovation_essentials.cybersyn.domain_characteristics (schema)
  Compiling sdf_snowflake.cybersyn_tech_innovation.active_ai_domains (./src/sdf_snowflake/cybersyn_tech_innovation/active_ai_domains.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 2.124 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
  Compiling sdf_snowflake.staging.latest_repo_name (./src/sdf_snowflake/staging/latest_repo_name.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 2.521 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
   ...
   Finished 2 models [1 succeeded, 1 downloaded] in 8.935 secs

Table sdf_snowflake.staging.latest_repo_name
+-----------------------------------------+-----------+
| repo_name                               | repo_id   |
+-----------------------------------------+-----------+
| robetbangunlegato/penjualangas          | 812838332 |
| guilubs/Trabalho-A3_Jose-Guilherme-     | 813350234 |
| uma-rajesh45/issue-tracker              | 812849923 |
| valentyna88/goit-js-hw-02               | 812965677 |
| chaitanyapalakurthi/chaitanyapalakurthi | 813221799 |
| ronair212/ChickenDiseasaeClassification | 812097620 |
| akashbirthal23/vessel_tracker           | 813044723 |
| hazardchik/foodgram-project-react       | 708668948 |
| SLviski/SLviski                         | 813254385 |
| Shiang-An/EtiquetteCompany              | 813085640 |
+-----------------------------------------+-----------+
10 rows.
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (./src/sdf_snowflake/cybersyn_tech_innovation/events_by_repo.sql)
   Finished 13 models [6 succeeded, 7 downloaded] in 2.276 secs
