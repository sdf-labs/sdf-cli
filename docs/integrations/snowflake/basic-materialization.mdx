...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
   ...
   Finished 2 models [1 succeeded, 1 downloaded] in 5.246 secs

Table sdf_snowflake.staging.latest_repo_name
+--------------------------------------------------+-----------+
| repo_name                                        | repo_id   |
+--------------------------------------------------+-----------+
| C043/U2W1D5                                      | 808502265 |
| Senko-heart/keisho                               | 808599977 |
| freddysundowner/lowcoder-gantt                   | 808461687 |
| charankuramana09/Gurukul-Home-Tuitions-Backend   | 808635807 |
| MADDCIENCEMASTER10/SigmaSite                     | 808677742 |
| fernanda1102/testeHTML                           | 808766599 |
| SvRomanova/misha3                                | 808608737 |
| monu-daffodilsw/monu-daffodilsw                  | 808567805 |
| WoogaAndrew/nct.remote.test.2024053115-0457.4817 | 808623026 |
| Moshe-f/tic-tac-toe                              | 808649611 |
+--------------------------------------------------+-----------+
10 rows.
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  Compiling sdf_snowflake.staging.push_events (./src/sdf_snowflake/staging/push_events.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 1.574 secs
...
Downloading tech__innovation_essentials.cybersyn.uspto_patent_index (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (./src/sdf_snowflake/cybersyn_tech_innovation/events_by_repo.sql)
   Finished 13 models [6 succeeded, 7 downloaded] in 1.518 secs
