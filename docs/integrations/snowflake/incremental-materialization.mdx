...
``` shell
    ...
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/compiled-files/src/sdf_snowflake/cybersyn_tech_innovation/most_starred_repos.sql
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/compiled-queries/sdf_snowflake/cybersyn_tech_innovation/most_starred_repos.sql
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/data/tech__innovation_essentials/cybersyn/github_repos/data_0.parquet
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/data/tech__innovation_essentials/cybersyn/github_stars/data_0.parquet
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/std/.gitignore
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/std/macros/generate_date_values.jinja
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/std/macros/generate_integer_values.jinja
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/std/macros/materialize.jinja
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/std/macros/star.jinja
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/std/macros/surrogate_key.jinja
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/std/macros/test.jinja
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/std/workspace.sdf.yml
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/table/tech__innovation_essentials/cybersyn/github_repos.sdf.yml
    Created cybersyn_tech_innovation_incremental/.sdfcache/dbg/table/tech__innovation_essentials/cybersyn/github_stars.sdf.yml
...
Downloading tech__innovation_essentials.cybersyn.domain_characteristics (schema)
  Compiling sdf_snowflake.cybersyn_tech_innovation.active_ai_domains (./src/sdf_snowflake/cybersyn_tech_innovation/active_ai_domains.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 2.117 secs
...
└─────────────┴───────────┴────────────┴─────────────┘
    ...
    <Step title="Materialize an Increment Model">
      ...
      Let's start creating a file called `datafusion_push_events.sql` in the directory `src/sdf_snowflake/staging/` and adding the following SQL to it:

      ```sql src/sdf_snowflake/staging/datafusion_push_events.sql
      SELECT
        *
      FROM
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  Compiling sdf_snowflake.staging.datafusion_push_events (./src/sdf_snowflake/staging/datafusion_push_events.sql)
   Finished 2 models [1 succeeded, 1 downloaded] in 3.093 secs
...
└────────────────────────────────┴────────────────┴────────────┴─────────────┘
      ...
      ```shell
      sdf run src/sdf_snowflake/staging/datafusion_push_events.sql
      ```
    ...
    Let's start by adding a new SQL file to our workspace called `top_datafusion_contributors.sql` in the directory `src/sdf_snowflake/cybersyn_tech_innovation/` with the following SQL:
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.top_datafusion_contributors (./src/sdf_snowflake/cybersyn_tech_innovation/top_datafusion_contributors.sql)
   Finished 3 models [2 succeeded, 1 downloaded] in 2.986 secs
