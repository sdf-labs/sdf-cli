...
&nbsp;&nbsp;&nbsp;Finished&nbsp;3&nbsp;models&nbsp;[3&nbsp;succeeded]&nbsp;in&nbsp;0.766&nbsp;secs
...
&nbsp;&nbsp;&nbsp;Finished&nbsp;6&nbsp;models&nbsp;[6&nbsp;succeeded]&nbsp;in&nbsp;0.799&nbsp;secs
...
&nbsp;&nbsp;&nbsp;Finished&nbsp;7&nbsp;models&nbsp;[7&nbsp;succeeded]&nbsp;in&nbsp;0.809&nbsp;secs
...
&nbsp;&nbsp;Compiling&nbsp;jaffle_shop.staging.stg_payments&nbsp;(./models/staging/stg_payments.sql)
&nbsp;&nbsp;Compiling&nbsp;jaffle_shop.analytics.orders&nbsp;(./models/analytics/orders.sql)
&nbsp;&nbsp;&nbsp;Finished&nbsp;7&nbsp;models&nbsp;[7&nbsp;succeeded]&nbsp;in&nbsp;0.788&nbsp;secs
...
&nbsp;&nbsp;&nbsp;&nbsp;Running&nbsp;jaffle_shop.analytics.orders&nbsp;(./models/analytics/orders.sql)
&nbsp;&nbsp;&nbsp;Finished&nbsp;7&nbsp;models&nbsp;[7&nbsp;succeeded],&nbsp;3&nbsp;tests&nbsp;[3&nbsp;passed]&nbsp;in&nbsp;0.907&nbsp;secs
...
&nbsp;&nbsp;Compiling&nbsp;jaffle_shop.analytics.orders&nbsp;(./models/analytics/orders.sql)
&nbsp;&nbsp;&nbsp;Finished&nbsp;8&nbsp;models&nbsp;[8&nbsp;succeeded]&nbsp;in&nbsp;0.838&nbsp;secs
...
&nbsp;&nbsp;&nbsp;&nbsp;Running&nbsp;jaffle_shop.analytics.orders&nbsp;(./models/analytics/orders.sql)
&nbsp;&nbsp;&nbsp;Finished&nbsp;8&nbsp;models&nbsp;[8&nbsp;succeeded]&nbsp;in&nbsp;0.880&nbsp;secs
