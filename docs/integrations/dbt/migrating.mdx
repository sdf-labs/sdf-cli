...
&nbsp;&nbsp;&nbsp;Finished&nbsp;3&nbsp;models&nbsp;[3&nbsp;succeeded]&nbsp;in&nbsp;0.593&nbsp;secs
...
&nbsp;&nbsp;&nbsp;Finished&nbsp;6&nbsp;models&nbsp;[6&nbsp;succeeded]&nbsp;in&nbsp;0.609&nbsp;secs
...
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;jaffle_shop.staging.stg_customers&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;jaffle_shop.staging.stg_payments&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;&nbsp;Running&nbsp;jaffle_shop.staging.stg_orders&nbsp;(./models/staging/stg_orders.sql)
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;jaffle_shop.staging.stg_orders&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;Finished&nbsp;6&nbsp;models&nbsp;[6&nbsp;succeeded]&nbsp;in&nbsp;0.619&nbsp;secs
...
&nbsp;&nbsp;&nbsp;Finished&nbsp;7&nbsp;models&nbsp;[7&nbsp;succeeded]&nbsp;in&nbsp;0.654&nbsp;secs
...
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;jaffle_shop.analytics.orders&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;Finished&nbsp;5&nbsp;models&nbsp;[5&nbsp;succeeded]&nbsp;in&nbsp;0.656&nbsp;secs
...
&nbsp;&nbsp;Compiling&nbsp;jaffle_shop.staging.stg_orders&nbsp;(./models/staging/stg_orders.sql)
&nbsp;&nbsp;Compiling&nbsp;jaffle_shop.analytics.orders&nbsp;(./models/analytics/orders.sql)
&nbsp;&nbsp;&nbsp;Finished&nbsp;7&nbsp;models&nbsp;[7&nbsp;succeeded]&nbsp;in&nbsp;0.637&nbsp;secs
...
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;jaffle_shop.staging.test_stg_customers&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;&nbsp;Running&nbsp;jaffle_shop.analytics.orders&nbsp;(./models/analytics/orders.sql)
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;jaffle_shop.staging.test_stg_payments&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;&nbsp;Testing&nbsp;jaffle_shop.staging.test_stg_orders&nbsp;(./sdftarget/dbg/tests/jaffle_shop/staging/test_stg_orders.sql)
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;jaffle_shop.staging.test_stg_orders&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;jaffle_shop.analytics.orders&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;Finished&nbsp;7&nbsp;models&nbsp;[7&nbsp;succeeded],&nbsp;3&nbsp;tests&nbsp;[3&nbsp;passed]&nbsp;in&nbsp;0.709&nbsp;secs
...
&nbsp;&nbsp;Compiling&nbsp;jaffle_shop.analytics.orders&nbsp;(./models/analytics/orders.sql)
&nbsp;&nbsp;&nbsp;Finished&nbsp;8&nbsp;models&nbsp;[8&nbsp;succeeded]&nbsp;in&nbsp;0.637&nbsp;secs
...
&nbsp;&nbsp;&nbsp;&nbsp;Running&nbsp;jaffle_shop.analytics.orders&nbsp;(./models/analytics/orders.sql)
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;jaffle_shop.analytics.orders&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;jaffle_shop.analytics.customers&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;Finished&nbsp;8&nbsp;models&nbsp;[8&nbsp;succeeded]&nbsp;in&nbsp;0.688&nbsp;secs
...
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;jaffle_shop.analytics.test_customers&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;jaffle_shop.analytics.test_orders&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;Finished&nbsp;8&nbsp;models&nbsp;[8&nbsp;succeeded],&nbsp;5&nbsp;tests&nbsp;[5&nbsp;passed]&nbsp;in&nbsp;0.764&nbsp;secs
[Pass]&nbsp;Test&nbsp;jaffle_shop.staging.test_stg_customers
[Pass]&nbsp;Test&nbsp;jaffle_shop.staging.test_stg_orders
[Pass]&nbsp;Test&nbsp;jaffle_shop.staging.test_stg_payments
...
2. **Ternary `if` Statements with no `else`** - An `else` is required in ternary conditional statements.
    ...
    SDF's implemnentation requires an `else` after `loop.last`:
    ```jinja
    group by {% for i in range(1, n + 1) -%}
...
<Tip>
  If you find any others, please let us know via our [Slack Community](https://join.slack.com/t/sdfcommunity/shared_invite/zt-2lkokt7ed-xIR0_pcmUOU3~CebxuqeKg) or [GitHub Issues](https://github.com/sdf-labs/sdf-cli/issues).
</Tip>
