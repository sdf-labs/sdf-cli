...
&nbsp;&nbsp;&nbsp;Finished&nbsp;3&nbsp;models&nbsp;[3&nbsp;succeeded]&nbsp;in&nbsp;0.837&nbsp;secs
...
&nbsp;&nbsp;&nbsp;Finished&nbsp;6&nbsp;models&nbsp;[6&nbsp;succeeded]&nbsp;in&nbsp;0.868&nbsp;secs
...
&nbsp;&nbsp;&nbsp;Finished&nbsp;7&nbsp;models&nbsp;[7&nbsp;succeeded]&nbsp;in&nbsp;0.875&nbsp;secs
...
&nbsp;&nbsp;&nbsp;Finished&nbsp;5&nbsp;models&nbsp;[5&nbsp;succeeded]&nbsp;in&nbsp;0.892&nbsp;secs
...
&nbsp;&nbsp;Compiling&nbsp;jaffle_shop.staging.stg_orders&nbsp;(./models/staging/stg_orders.sql)
&nbsp;&nbsp;Compiling&nbsp;jaffle_shop.analytics.orders&nbsp;(./models/analytics/orders.sql)
&nbsp;&nbsp;&nbsp;Finished&nbsp;7&nbsp;models&nbsp;[7&nbsp;succeeded]&nbsp;in&nbsp;0.895&nbsp;secs
...
&nbsp;&nbsp;Compiling&nbsp;jaffle_shop.analytics.orders&nbsp;(./models/analytics/orders.sql)
&nbsp;&nbsp;&nbsp;Finished&nbsp;8&nbsp;models&nbsp;[8&nbsp;succeeded]&nbsp;in&nbsp;0.871&nbsp;secs
...
&nbsp;&nbsp;&nbsp;&nbsp;Running&nbsp;jaffle_shop.analytics.orders&nbsp;(./models/analytics/orders.sql)
&nbsp;&nbsp;&nbsp;Finished&nbsp;8&nbsp;models&nbsp;[8&nbsp;succeeded]&nbsp;in&nbsp;0.932&nbsp;secs
...
&nbsp;&nbsp;&nbsp;Finished&nbsp;8&nbsp;models&nbsp;[8&nbsp;succeeded],&nbsp;5&nbsp;tests&nbsp;[5&nbsp;passed]&nbsp;in&nbsp;1.009&nbsp;secs
[Pass]&nbsp;Test&nbsp;jaffle_shop.staging.test_stg_customers
[Pass]&nbsp;Test&nbsp;jaffle_shop.staging.test_stg_orders
[Pass]&nbsp;Test&nbsp;jaffle_shop.staging.test_stg_payments
