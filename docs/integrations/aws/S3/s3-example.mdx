...
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;hello_world.pub.popdata&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
...
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;hello_world.pub.world_metrics_1&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;hello_world.pub.world_metrics&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
...
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;hello_world.pub.un_pop_data&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
...
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;hello_world.pub.q1&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;Finished&nbsp;2&nbsp;models&nbsp;[2&nbsp;succeeded]&nbsp;in&nbsp;2.257&nbsp;secs
