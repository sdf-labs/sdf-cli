...
&nbsp;&nbsp;&nbsp;Finished&nbsp;11&nbsp;models&nbsp;[11&nbsp;succeeded]&nbsp;in&nbsp;0.203&nbsp;secs
        ...
        <Note>
            `sdf compile` will always be executed before `sdf run` so this step is not mandatory 
...
&nbsp;&nbsp;&nbsp;Finished&nbsp;7&nbsp;models&nbsp;[7&nbsp;succeeded]&nbsp;in&nbsp;0.225&nbsp;secs
