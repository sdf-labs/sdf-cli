...
If you are using a cloud data warehouse alongside SDF, you may need to add your SDF cluster's IP address to your cloud warehouse's IP allowlist. This is because the SDF Cloud needs to access your data warehouse to compile your workspace.
