...
<Steps>
    ...
    <Step title="Fill out the Required Fields for you Selected Provider:">
        ...
        2. **Snowflake Credentials**
            - **Required Fields**: Account ID, Username, Password
            - **Optional Fields**: Role, Warehouse
        <Note>
...
[Snowflake Getting Started Guide](/integrations/snowfalek/getting-started) or the [Redshift Getting Started Guide](/integrations/redshift/getting-started).
</Note>
