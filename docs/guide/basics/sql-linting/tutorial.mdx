...
<pre style={{ fontFamily: 'monospace', backgroundColor: 'transparent' }} className='language-error'>
<code className='language-error'>
error:&nbsp;SDF1013:&nbsp;linter:&nbsp;unknown&nbsp;field&nbsp;`case&#45;keyword`,&nbsp;expected&nbsp;one&nbsp;of&nbsp;`name`,&nbsp;`defaults`,&nbsp;`layout&#45;rules`,&nbsp;`syntax&#45;rules`,&nbsp;`semantic&#45;rules`,&nbsp;`performance&#45;rules`,&nbsp;`check&#45;rules`&nbsp;at&nbsp;line&nbsp;19&nbsp;column&nbsp;3
&nbsp;&nbsp;&#45;&#45;&gt;&nbsp;workspace.sdf.yml:19:3
