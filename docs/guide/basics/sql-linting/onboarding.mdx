...
&nbsp;&nbsp;&nbsp;&nbsp;disallow&#45;implicit&#45;conversions&#45;in:&nbsp;[]&nbsp;
  ...
  **Manual Fixes**
  ...
  <Step title="Iterate">
    ...
    We highly recommend checking out our advanced rules ([semantic](/reference/lint-rules#semantic-rules), 
    [performance](/reference/lint-rules#performance-rules), [checks](/reference/lint-rules#check-rules)) to take your SQL correctness and 
