...
| ----------- | ------------- | --------- | --------------- | -------- | -------- |
| Syntax      | `case_keyword` | SDF107 | L010              |    ✅    | `consistent` |
| Syntax      | `case-literal` | SDF108, SDF109  | L040     |     ✅   | `consistent` |
| Syntax      | `case-type` | SDF110        | L063            |    ✅    | `consistent` |
| Syntax      | `case-function` | SDF106 | L030 |    ✅    | `off` |
...
| Syntax      | `no-unnecessary-quoted-identifiers` | SDF118 | L059 |    ❌    | `on` |
| Syntax      | `ctx-strict-qualified-column-reference` | SDF112 | L028 |    ❌    | `consistent` |
| Syntax      | `no-unqualified-multi-source-column-reference` | SDF116 | L027 |    ❌    | `on` |
| Syntax      | `no-inconsistent-ordinal-column-reference` | SDF105 | L054 |    ❌    | `on` |
| Syntax      | `no-unnecessary-else` | SDF119 | L035 |    ❌    | `on` |
| Syntax      | `no-unnecessary-case` | SDF120 | L043 |    ❌    | `on` |
| Syntax      | `no-unused-cte` | SDF121 | L045 |    ❌    | `on` |
| Syntax      | `no-unnecessary-nested-case` | SDF122 | L058 |    ❌    | `on` |
| Syntax      | `no-distinct-parenthesis` | SDF123 | L015 |    ❌    | `on` |
| Syntax      | `strict-join-condition-order` | SDF114 | ST09 |    ❌    | `on` |
| Syntax      | `strict-wildcard-order` | SDF115 | L034 |    ❌    | `on` |
| Syntax      | `no-trailing-semicolon` | SDF111 | L052 |    ❌    | `on` |
| Semantic    | `case-column` | --------- | --------------- |    ❌    | `off` |
