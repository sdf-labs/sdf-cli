...
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;hello.pub.main&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;&nbsp;Testing&nbsp;hello.pub.test_main&nbsp;(./sdftarget/dbg/tests/hello/pub/test_main.sql)
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;hello.pub.test_main&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;Finished&nbsp;1&nbsp;model&nbsp;[1&nbsp;succeeded],&nbsp;1&nbsp;test&nbsp;[1&nbsp;passed]&nbsp;in&nbsp;0.621&nbsp;secs
...
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;tests_workspace.pub.raw_inapp_events&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;&nbsp;Testing&nbsp;tests_workspace.pub.test_raw_inapp_events&nbsp;(./sdftarget/dbg/tests/tests_workspace/pub/test_raw_inapp_events.sql)
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;tests_workspace.pub.test_raw_inapp_events&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;Finished&nbsp;1&nbsp;model&nbsp;[1&nbsp;succeeded],&nbsp;1&nbsp;test&nbsp;[1&nbsp;passed]&nbsp;in&nbsp;0.641&nbsp;secs
...
&nbsp;&nbsp;&nbsp;&nbsp;Testing&nbsp;tests_workspace.pub.test_raw_inapp_events&nbsp;(./sdftarget/dbg/tests/tests_workspace/pub/test_raw_inapp_events.sql)
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;tests_workspace.pub.test_raw_inapp_events&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;Finished&nbsp;1&nbsp;model&nbsp;[1&nbsp;succeeded],&nbsp;1&nbsp;test&nbsp;[1&nbsp;failed]&nbsp;in&nbsp;0.645&nbsp;secs,&nbsp;for&nbsp;details&nbsp;see&nbsp;below.
...
&#45;&#45;&#45;&#45;&#45;&#45;&#45;
Summary&nbsp;1&nbsp;model&nbsp;[1&nbsp;succeeded],&nbsp;1&nbsp;test&nbsp;[1&nbsp;failed]&nbsp;in&nbsp;0.645&nbsp;secs.
&#45;&#45;&#45;&#45;&#45;&#45;&#45;
...
<code className='language-error'>
&nbsp;&nbsp;&nbsp;&nbsp;Running&nbsp;hello.pub.main&nbsp;(./models/main.sql)
&nbsp;&nbsp;&nbsp;&nbsp;Testing&nbsp;hello.pub.generic_test&nbsp;(./tests/generic_test.sql)
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;hello.pub.main&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;hello.pub.generic_test&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;Finished&nbsp;1&nbsp;model&nbsp;[1&nbsp;succeeded],&nbsp;1&nbsp;test&nbsp;[1&nbsp;failed]&nbsp;in&nbsp;0.624&nbsp;secs,&nbsp;for&nbsp;details&nbsp;see&nbsp;below.
[Fail]&nbsp;Test&nbsp;hello.pub.generic_test
┌─────┐
│&nbsp;col&nbsp;│
╞═════╡
│&nbsp;1&nbsp;&nbsp;&nbsp;│
...
&#45;&#45;&#45;&#45;&#45;&#45;&#45;
Summary&nbsp;1&nbsp;model&nbsp;[1&nbsp;succeeded],&nbsp;1&nbsp;test&nbsp;[1&nbsp;failed]&nbsp;in&nbsp;0.624&nbsp;secs.
&#45;&#45;&#45;&#45;&#45;&#45;&#45;
...
&nbsp;&nbsp;&nbsp;&nbsp;Testing&nbsp;tests_workspace.pub.test_raw_inapp_events&nbsp;(./sdftarget/dbg/tests/tests_workspace/pub/test_raw_inapp_events.sql)
&nbsp;&nbsp;&nbsp;&nbsp;Warning&nbsp;tests_workspace.pub.test_raw_inapp_events&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&nbsp;Finished&nbsp;1&nbsp;model&nbsp;[1&nbsp;succeeded],&nbsp;1&nbsp;test&nbsp;[1&nbsp;passed]&nbsp;in&nbsp;0.623&nbsp;secs
[Pass]&nbsp;Test&nbsp;tests_workspace.pub.test_raw_inapp_events
