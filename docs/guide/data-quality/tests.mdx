...
&nbsp;&nbsp;&nbsp;Finished&nbsp;1&nbsp;model&nbsp;[1&nbsp;succeeded],&nbsp;1&nbsp;test&nbsp;[1&nbsp;passed]&nbsp;in&nbsp;0.797&nbsp;secs
...
&nbsp;&nbsp;&nbsp;Finished&nbsp;1&nbsp;model&nbsp;[1&nbsp;succeeded],&nbsp;1&nbsp;test&nbsp;[1&nbsp;passed]&nbsp;in&nbsp;0.879&nbsp;secs
...
<pre style={{ fontFamily: 'monospace', backgroundColor: 'transparent' }} className='language-error'>
<code className='language-error'>
warning:&nbsp;SDF2001:&nbsp;hello.pub.main:&nbsp;attempting&nbsp;to&nbsp;execute&nbsp;Trino,&nbsp;local&nbsp;execution&nbsp;is&nbsp;currently&nbsp;experimental
&nbsp;&nbsp;&#45;&#45;&gt;&nbsp;models/main.sql:1
