...
Working set 1 test file, 1 .sdf file
   ...
   Finished 1 model [1 succeeded], 1 check [1 passed] in 1.015 secs
...
Working set 1 test file, 1 .sdf file
    Testing hello.pub.code_check (./checks/code_check.sql)
   Finished 1 model [1 succeeded], 1 check [1 failed] in 1.003 secs, for details see below.
...
-------
Summary 1 model [1 succeeded], 1 check [1 failed] in 1.003 secs.
-------
...
Working set 1 test file, 1 .sdf file
    Testing hello.pub.code_check (./checks/code_check.sql)
   Finished 2 models [2 succeeded], 1 check [1 passed] in 0.993 secs
[Pass] Check hello.pub.code_check
