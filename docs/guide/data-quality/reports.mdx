...
&nbsp;&nbsp;&nbsp;Finished&nbsp;12&nbsp;models&nbsp;[12&nbsp;succeeded],&nbsp;1&nbsp;report&nbsp;[1&nbsp;succeeded]&nbsp;in&nbsp;0.486&nbsp;secs
...
Working&nbsp;set&nbsp;1&nbsp;report&nbsp;file,&nbsp;1&nbsp;.sdf&nbsp;file
&nbsp;&nbsp;Reporting&nbsp;sdf.reports.tables_with_pii&nbsp;(./reports/tables_with_pii.sql)
&nbsp;&nbsp;&nbsp;Finished&nbsp;12&nbsp;models&nbsp;[12&nbsp;reused],&nbsp;1&nbsp;report&nbsp;[1&nbsp;succeeded]&nbsp;in&nbsp;0.405&nbsp;secs
...
&nbsp;&nbsp;&nbsp;Finished&nbsp;12&nbsp;models&nbsp;[12&nbsp;reused],&nbsp;2&nbsp;reports&nbsp;[1&nbsp;succeeded,&nbsp;1&nbsp;reused]&nbsp;in&nbsp;0.425&nbsp;secs
