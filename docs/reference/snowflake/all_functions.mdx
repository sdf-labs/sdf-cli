...
function !=<$1, $2> (<$1, $2>) returns boolean
	where $1 in (varchar, object)
	and $2 in (varchar, object)
```
...
```sql
function sdf::and<$1> (<$1, boolean>) returns boolean
	where $1 in (int, double)
```


```sql
function sdf::and<$1> (<boolean, $1>) returns boolean
	where $1 in (int, double)
```
...
```sql
function sdf::or<$1> (<$1, boolean>) returns boolean
	where $1 in (int, double)
```


```sql
function sdf::or<$1> (<boolean, $1>) returns boolean
	where $1 in (int, double)
```
