...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/alert_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/auto_refresh_registration_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/automatic_clustering_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/complete_task_graphs)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/copy_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/current_task_graphs)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/data_transfer_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/database_refresh_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/database_refresh_progress)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/database_refresh_progress_by_job)
...
>
	...
	and $2 in (date, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/database_replication_usage_history)
...
>
	...
	and $2 in (date, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/database_storage_usage_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/dynamic_table_graph_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/dynamic_table_refresh_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/external_functions_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/external_table_file_registration_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/external_table_files)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/login_history)
...
function login_history_by_user $1, $2() returns struct<event_timestamp timestamp, event_id bigint, event_type string, user_name string, client_ip string, reported_client_type string, reported_client_version string, first_authentication_factor string, second_authentication_factor string, is_success string, error_code bigint, error_message string, related_event_id bigint, "connection" string>
	...
	and $2 in (timestamp, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/login_history_by_user)
...
function materialized_view_refresh_history $1, $2() returns struct< start_time timestamp, end_time timestamp, credits_used string, materialized_view_name string >
	...
	and $2 in (date, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/materialized_view_refresh_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/notification_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/pipe_usage_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/policy_references)
...
>
	...
	and $2 in (date, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/query_acceleration_history)
...
function query_history $1, $2() returns struct<query_id string,
  ...
  query_parameterized_hash_version bigint>
	...
	and $2 in (timestamp, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/query_history)
...
function query_history_by_session $1, $2() returns struct<query_id string,
  ...
  query_parameterized_hash_version bigint>
	...
	and $2 in (timestamp, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/query_history_by_session)
...
function query_history_by_user $1, $2() returns struct<query_id string,
  ...
  query_parameterized_hash_version bigint>
	...
	and $2 in (timestamp, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/query_history_by_user)
...
function query_history_by_warehouse $1, $2() returns struct<query_id string,
  ...
  query_parameterized_hash_version bigint>
	...
	and $2 in (timestamp, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/query_history_by_warehouse)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/replication_group_refresh_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/replication_group_refresh_progress)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/replication_group_refresh_progress_by_job)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/replication_group_usage_history)
...
>
	...
	and $2 in (date, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/replication_usage_history)
...
>
	...
	and $2 in (timestamp, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/search_optimization_history)
...
>
	...
	and $2 in (timestamp, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/serverless_task_history)
...
>
	...
	where $1 in (timestamp, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/stage_directory_file_registration_history)
...
function stage_storage_usage_history $1, $2() returns struct<usage_date date, average_stage_bytes bigint>
	...
	and $2 in (date, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/stage_storage_usage_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/tag_references)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/tag_references_all_columns)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/task_dependents)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/task_history)
...
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/validate_pipe_load)
...
>
	...
	and $2 in (date, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/warehouse_load_history)
...
>
	...
	and $2 in (date, string)
```
[🔗 Official Documentation](https://docs.snowflake.com/en/sql-reference/functions/warehouse_metering_history)
