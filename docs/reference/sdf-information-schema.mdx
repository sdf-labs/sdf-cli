...
| `table_name` | varchar not null | The table's name |
...
##### The INFORMATION_SCHEMA.COLUMNS view contains one row for each column in a table, view, or table-valued function.
| column_name | data_type | description |
|-------------|-----------|-------------|
...
| `table_name` | varchar not null | The name of the table containing this column |
| `column_name` | varchar not null | The name of the column |
| `description` | varchar | The description of this column defined in the table's yaml or SQL |
...
| `is_nullable` | varchar | Whether or not this column can contain a null value |
