...
`metadata` | Metadata are .sdf.yml files to add additional metadata. To learn more: https://docs.sdf.com/reference/sdf-yml#enum-includetype|
...
`compute:` | [`ComputeKind?`](#enum-computekind)| DEPRECATED; subsumed by providers/integrations information|
