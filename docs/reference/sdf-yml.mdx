...
|Field | Type | Description|
| :---- | :--- | :------- |
`name:` | [`String`](#nested-element-string)| The name of the table (syntax: [[catalog.]schema].table)
...
`dialect:` | [`Dialect?`](#enum-dialect)| The dialect of this table, defaults to &#96;trino&#96;|
...
`password:` | `string`| The password to connect to snowflake|
...
Value | Description|
| :--- | :------- |
`model` | Models are .sql files (ddls or queries) used for data transformation. To learn more: https://docs.sdf.com/reference/sdf-yml#enum-includetype|
`test` | Tests are expectations against the data of models. Uses the sdf-test library by default. To learn more: https://docs.sdf.com/reference/sdf-yml#enum-includetype|
`check` | Checks are logical expectations expresses as queries against the information schema of the SDF workspace. To learn more: https://docs.sdf.com/reference/sdf-yml#enum-includetype|
`report` | Reports are informational  queries against the information schema of the SDF workspace. To learn more: https://docs.sdf.com/reference/sdf-yml#enum-includetype|
`stat` | Statistics are informational queries against the data of the models. To learn more: https://docs.sdf.com/reference/sdf-yml#enum-includetype|
`resource` | Resources are local data files (like parquet, csv, or json) used by models in the workspace. To learn more: https://docs.sdf.com/reference/sdf-yml#enum-includetype|
`metadata` | [Deprecated] Metadata are .sdf.yml files to add additional metadata. To learn more: https://docs.sdf.com/reference/sdf-yml#enum-includetype|
`spec` | Specifications are .sdf.yml files to configure your workspace and add additional metadata. To learn more: https://docs.sdf.com/reference/sdf-yml#enum-includetype|
`macro` | Macros are .jinja files that define reusable SQL code. To learn more: https://docs.sdf.com/reference/sdf-yml#enum-includetype|
`seed` | Seeds are data files used both locally and in remote data warehouses. To learn more: https://docs.sdf.com/reference/sdf-yml#enum-includetype|
## Enum: `IndexMethod`
Value | Description|
| :--- | :------- |
`scan-dbt` | undefined|
...
`join`
`from`
## Enum: `ImplicitConversionOperators`
Values |
| :--- |
`eq`
`in`
...
|Field | Type | Description|
| :---- | :--- | :------- |
`strategy:` | [`SnapshotStrategy`](#enum-snapshotstrategy)| Snapshot strategy; may be one of &#96;timestamp&#96; (default), or &#96;check&#96;|
...
`updated-at:` | [`String?`](#nested-element-string)| Name of the timestamp column used to identify the last update time This option is only required for the &#96;timestamp&#96; snapshot strategy|
`check-cols:` | [`CheckColsSpec?`](#enum-checkcolsspec)| Specification of which columns to check for change (may be a list of column names or &#96;all&#96;) This option is only required for the &#96;check&#96; snapshot strategy|
...
`access_key:` | `string`| |
`secret_key:` | `string`| |
### Nested element: `Linter`
|Field | Type | Description|
| :---- | :--- | :------- |
`name:` | `string`| The name of these lint rules, e.g. &quot;my_rules&quot;, can be referenced in defaults|
`defaults:` | [`RuleOn`](#enum-ruleon)| The overall switch, default is off|
`layout-rules:` | [`LayoutRules?`](#nested-element-layoutrules)| These rules check for proper spacing|
`syntax-rules:` | [`SyntaxRules?`](#nested-element-syntaxrules)| |
`semantic-rules:` | [`SemanticRules?`](#nested-element-semanticrules)| |
`performance-rules:` | [`PerformanceRules?`](#nested-element-performancerules)| |
`check-rules:` | `object?`| |
### Nested element: `LayoutRules`
|Field | Type | Description|
| :---- | :--- | :------- |
### Nested element: `SyntaxRules`
|Field | Type | Description|
| :---- | :--- | :------- |
`case-keyword:` | [`Capitalization?`](#enum-capitalization)| Inconsistent capitalization of keywords |
`case-literal:` | [`Capitalization?`](#enum-capitalization)| Inconsistent capitalization of &#96;boolean&#96;/&#96;null&#96; literal |
`case-type:` | [`Capitalization?`](#enum-capitalization)| Inconsistent capitalization of datatypes. |
`case-function:` | [`Capitalization?`](#enum-capitalization)| Inconsistent capitalization of function names |
`disallow-these-identifiers:` | `[string]?`| |
`flag-keywords-used-as-identifiers:` | `[string]?`| Keywords should not be used as identifiers |
`disallow-these-chars-in-quoted-identifiers:` | `string?`| Do not use special characters in identifiers |
`flag-unnecessary-quoted-identifiers:` | [`RuleOn?`](#enum-ruleon)| Unnecessary quoted identifier |
`flag-inconsistent-qualified-column-reference:` | [`ColumnQualifier?`](#enum-columnqualifier)| Inconsistent column references in SELECT clause of both qualified and unqualified references |
`flag-unqualified-multi-source-column-reference:` | [`RuleOn?`](#enum-ruleon)| Columns reference should specify source table or view in queries with more than one source. |
`flag-inconsistent-ordinal-column-reference:` | [`RuleOn?`](#enum-ruleon)| Inconsistent column references in GROUP BY/ORDER BY clauses of both ordinal and non-ordinal |
`flag-unnecessary-else:` | [`RuleOn?`](#enum-ruleon)| Redundant &#96;ELSE NULL&#96; in a case when statement |
`flag-unnecessary-case:` | [`RuleOn?`](#enum-ruleon)| CASE statement can be simplified |
`flag-unused-cte:` | [`RuleOn?`](#enum-ruleon)| Query defines a CTE (common-table expression) but does not use it |
`flag-unnecessary-nested-case:` | [`RuleOn?`](#enum-ruleon)| Nested CASE statement in ELSE clause could be flattened. |
`flag-distinct-parenthesis:` | [`RuleOn?`](#enum-ruleon)| DISTINCT used with parentheses |
`disallow-subquery-in:` | `array`| Join/From clauses should not contain subqueries. Use CTEs instead |
`flag-misordered-join-condition:` | [`RuleOn?`](#enum-ruleon)| Join conditions column references should follow tables reference order |
`flag-select-item-order:` | [`RuleOn?`](#enum-ruleon)| Select wildcards then simple targets before calculations and aggregates. |
`flag-trailing-semicolon-after-statements:` | [`RuleOn?`](#enum-ruleon)| Statements should not end with a semi-colon. Multi-statements must be separated with a semi-colon but the final statement should NOT end with one. |
### Nested element: `SemanticRules`
|Field | Type | Description|
| :---- | :--- | :------- |
`case-column:` | [`Capitalization?`](#enum-capitalization)| Inconsistent capitalization of column names |
`case-table:` | [`Capitalization?`](#enum-capitalization)| Inconsistent capitalization of table names |
`case-alias:` | [`Capitalization?`](#enum-capitalization)| Inconsistent capitalization of alias |
`disallow-implicit-conversions-in:` | `array`| Prevent type implicit casting or coercion |
### Nested element: `PerformanceRules`
|Field | Type | Description|
| :---- | :--- | :------- |
`flag-function-application-in-where-on-indexed-columns:` | [`RuleOn?`](#enum-ruleon)| Avoid functions in where clauses over indexed, partitioned or clustered columns, to prevent filter push down and improve performance |
### Nested element: `FormatRules`
|Field | Type | Description|
| :---- | :--- | :------- |
`name:` | `string`| The name of formatter rules, e.g. &quot;my_rules&quot;, can be referenced in defaults|
`line-length:` | `integer?`| The line length|
