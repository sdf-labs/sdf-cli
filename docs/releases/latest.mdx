...
| Architecture           | Status | Version | Download |
| ---------------------- | ------ | ------- | -------- |
| Linux Intel X86-64     |   ✅   | v0.8.1-p  | [Download](https://cdn.sdf.com/releases/download/sdf-v0.8.1-p-x86_64-unknown-linux-musl.tar.gz) |
| Linux Arm ARM-64       |   ✅   | v0.8.1-p  | [Download](https://cdn.sdf.com/releases/download/sdf-v0.8.1-p-arm-unknown-linux-gnueabihf.tar.gz) |
| Apple Intel X86-64     |   ✅   | v0.8.1-p  | [Download](https://cdn.sdf.com/releases/download/sdf-v0.8.1-p-x86_64-apple-darwin.tar.gz) |
| Apple Arm AARCh-64     |   ✅   | v0.8.1-p  | [Download](https://cdn.sdf.com/releases/download/sdf-v0.8.1-p-aarch64-apple-darwin.tar.gz) |
