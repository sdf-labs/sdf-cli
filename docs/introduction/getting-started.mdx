...
``` shell
   ...
   Finished new in 0.283 secs

```

<Tip>
    You can view and modify the source code for all our examples directly in our [GitHub repository](https://github.com/sdf-labs/sdf-docs/tree/main/examples).
</Tip>
...
Working set 1 model file, 1 .sdf file
   ...
   Finished 1 model [1 succeeded] in 0.731 secs
...
Working set 2 model files, 1 .sdf file
  ...
  Compiling hello.pub.main2 (./src/main2.sql)
   Finished 2 models [2 succeeded] in 0.759 secs
main2.column_1
│
│ copy
└──────┐
