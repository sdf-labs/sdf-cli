...
## Installing SDF
  ...
  <Note>
    The install script will install the latest stable version of SDF by default.
  </Note>
  ...
  To install the latest preview version of SDF, you can use the `--preview` flag.
  ```shell
...
You can also update to a specific stable or preview version:
...
```shell
sudo sdf system update --version x.x.x-p
```
