...
| domain_id   | varchar   |            |
+-------------+-----------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 3.263 secs
...
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 3.054 secs
...
| repo_name                                                  | repo_id   |
+------------------------------------------------------------+-----------+
| AzaelLuxryA/Mat-328                                        | 767211529 |
| itsjeanem/realization-contribution                         | 800171381 |
| gangapurambhargav/cicd                                     | 800044631 |
| linfei748/bishe                                            | 799846573 |
| kaisunoo/SensEtryStatus                                    | 800006437 |
| gantres2/OLxA-Linux-Armbian-builder                        | 800017070 |
| dapdelivery/where-for-dinner-13-05-2024-16-16-59-183184236 | 800115838 |
| Nayyarnj1/site                                             | 799796261 |
| kersha0530/datafun-03-analytics                            | 800116331 |
| DanishKodeMonkey/odin-login-process                        | 799895907 |
+------------------------------------------------------------+-----------+
10 rows.
   Finished 1 model [1 succeeded] in 9.165 secs
...
| repo_id     | decimal(38, 0) |            |
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 3.155 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (aka sdf_snowflake.cybersyn_tech_innovation.events_by_repo)
   Finished 13 models [6 succeeded, 7 downloaded] in 3.431 secs
