...
| domain_id   | varchar   |            |
+-------------+-----------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 1.409 secs
...
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 1.575 secs
...
| repo_name                                        | repo_id   |
+--------------------------------------------------+-----------+
| j-hogben/fem-equalizer-landing-page              | 803279108 |
| monosodrac/jornada_python                        | 803524774 |
| yaelahros/bt                                     | 803354885 |
| Bisstocuz/aos-chatroom-bot                       | 803160509 |
| hasinaxp/linux_cpp                               | 803284750 |
| KalyanChinna235/BankManagement                   | 803426993 |
| AVJehoshua/Makers-Projects                       | 803377437 |
| chanteriam/abortion-legislation-content-analysis | 744309118 |
| RyanJamesThickett/biters-for-resources           | 803052139 |
| codeArtCreator/book-management                   | 803336913 |
+--------------------------------------------------+-----------+
10 rows.
   Finished 1 model [1 succeeded] in 5.215 secs
...
| repo_id     | decimal(38, 0) |            |
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 1.444 secs
...
Downloading tech__innovation_essentials.cybersyn.github_stars (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (./src/sdf_snowflake/cybersyn_tech_innovation/events_by_repo.sql)
   Finished 13 models [6 succeeded, 7 downloaded] in 1.541 secs
