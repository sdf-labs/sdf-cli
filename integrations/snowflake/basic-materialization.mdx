...
| domain_id   | varchar   |            |
+-------------+-----------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 1.553 secs
...
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 1.507 secs
...
| repo_name                                             | repo_id   |
+-------------------------------------------------------+-----------+
| exis-hgkim/testFlutterflowApp                         | 803531016 |
| abdonaser/mealify                                     | 803502465 |
| Asya-Yesayan/TestPages                                | 803166681 |
| Himabindu1312/Go-Fish-Sample-                         | 803533695 |
| hajruuudin/hajruuudin                                 | 803384233 |
| Akhilesh-Mohanasundaram/Avengers-Image-Classification | 803209862 |
| XingA02/XingA02.github.io                             | 803388653 |
| Mathewferreira343/estudos                             | 803223185 |
| kyu-chan0319/freee-auto-input-system                  | 803176556 |
| sthevenalves/linked-lists                             | 803299762 |
+-------------------------------------------------------+-----------+
10 rows.
   Finished 1 model [1 succeeded] in 5.369 secs
...
| repo_id     | decimal(38, 0) |            |
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 1.584 secs
...
Downloading tech__innovation_essentials.cybersyn.domain_characteristics (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (./src/sdf_snowflake/cybersyn_tech_innovation/events_by_repo.sql)
   Finished 13 models [6 succeeded, 7 downloaded] in 1.559 secs
