...
| domain_id   | varchar   |            |
+-------------+-----------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 3.032 secs
...
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 3.232 secs
...
| repo_name                                                       | repo_id   |
+-----------------------------------------------------------------+-----------+
| victorpauloti/samplelinux                                       | 803009969 |
| tomasprado96/bootstrap                                          | 803035866 |
| static-web-apps-testing-org/swa9e6e6d93550043bb83e16836669df2d3 | 802972644 |
| Pebriannn/micel.github.io                                       | 802946832 |
| DriverOnLips/homework-selenium-2024-spring                      | 802891851 |
| laydros/arch_installer                                          | 802956987 |
| raedbaff/ModernPortfolio                                        | 802905856 |
| tarunapatel/RestfulAPI-                                         | 802908626 |
| actias-nebula/terminal-wallet-cli                               | 802958773 |
| Amir7055/Onlly-html-css-camera-Ostad-                           | 802776762 |
+-----------------------------------------------------------------+-----------+
10 rows.
   Finished 1 model [1 succeeded] in 9.740 secs
...
| repo_id     | decimal(38, 0) |            |
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 3.255 secs
