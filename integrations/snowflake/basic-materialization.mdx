...
Downloading tech__innovation_essentials.cybersyn.domain_characteristics (schema)
  Compiling sdf_snowflake.cybersyn_tech_innovation.active_ai_domains (aka sdf_snowflake.cybersyn_tech_innovation.active_ai_domains)
...
| domain_id   | varchar   |            |
+-------------+-----------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 3.026 secs
...
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
  Compiling sdf_snowflake.staging.latest_repo_name (aka sdf_snowflake.staging.latest_repo_name)
...
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 3.115 secs
...
Working set 4 model files, 2 .sdf files
Downloading tech__innovation_essentials.cybersyn.github_repos (schema)
    Running sdf_snowflake.staging.latest_repo_name (aka sdf_snowflake.staging.latest_repo_name)

Table sdf_snowflake.staging.latest_repo_name
+---------------------------------------------------------------+-----------+
| repo_name                                                     | repo_id   |
+---------------------------------------------------------------+-----------+
| Zoommod/character-face-builder                                | 799740530 |
| yDanonin/factory-control                                      | 722592370 |
| HarshanUI/M2stock                                             | 800055214 |
| akryto/css-practice                                           | 799824873 |
| Elalersiss/Trabajo_en_clase                                   | 800178112 |
| AnnLvu/get_next_line_42                                       | 797706046 |
| Dani-A-Dias/lab-javascript-vikings                            | 800069883 |
| onetwosbeardedler6/animate-full-by-azi                        | 800000097 |
| abdosalahh/weeding                                            | 800183452 |
| devhub-blue-sea-us-east-1/org-public-empty-csc-repo-us-east-1 | 800167048 |
+---------------------------------------------------------------+-----------+
10 rows.
   Finished 1 model [1 succeeded] in 9.641 secs
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  Compiling sdf_snowflake.staging.push_events (aka sdf_snowflake.staging.push_events)
...
| repo_id     | decimal(38, 0) |            |
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 2.932 secs
...
Downloading tech__innovation_essentials.cybersyn.uspto_contributor_index (schema)
  Compiling sdf_snowflake.staging.latest_repo_name (aka sdf_snowflake.staging.latest_repo_name)
  Compiling sdf_snowflake.cybersyn_tech_innovation.active_ai_domains (aka sdf_snowflake.cybersyn_tech_innovation.active_ai_domains)
  Compiling sdf_snowflake.cybersyn_tech_innovation.most_starred_repos (aka sdf_snowflake.cybersyn_tech_innovation.most_starred_repos)
  Compiling sdf_snowflake.cybersyn_tech_innovation.all_nvidia_patents (aka sdf_snowflake.cybersyn_tech_innovation.all_nvidia_patents)
  Compiling sdf_snowflake.staging.push_events (aka sdf_snowflake.staging.push_events)
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (aka sdf_snowflake.cybersyn_tech_innovation.events_by_repo)
   Finished 13 models [6 succeeded, 7 downloaded] in 3.465 secs
