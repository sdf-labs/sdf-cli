...
| domain_id   | varchar   |            |
+-------------+-----------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 3.653 secs
...
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 3.301 secs
...
| repo_name                                                   | repo_id   |
+-------------------------------------------------------------+-----------+
| bryan-ilman-on-github/deployment-on-kubernetes              | 800088443 |
| hadimohagheghi/AdvancedAPI                                  | 799978189 |
| gabltz/bashscripts                                          | 799807113 |
| slskopytko/mdfmfmdchb                                       | 800222600 |
| MetadataGitTesting/S8I0JWEU                                 | 799889243 |
| realzain/portfolio                                          | 799816982 |
| sahil-gupta01/Custom-Auth-Service-Using-Springboot-Security | 799771006 |
| hrish7kesh/Robotics                                         | 764795574 |
| Sqfav/password_gen                                          | 800080477 |
| Tr3s3/psychic-telegram                                      | 799738420 |
+-------------------------------------------------------------+-----------+
10 rows.
   Finished 1 model [1 succeeded] in 8.442 secs
...
| repo_id     | decimal(38, 0) |            |
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 5.462 secs
...
Downloading tech__innovation_essentials.cybersyn.domain_characteristics (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (aka sdf_snowflake.cybersyn_tech_innovation.events_by_repo)
   Finished 13 models [6 succeeded, 7 downloaded] in 3.262 secs
