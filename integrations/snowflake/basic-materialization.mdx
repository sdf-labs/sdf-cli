...
| domain_id   | varchar   |            |
+-------------+-----------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 1.887 secs
...
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 2.064 secs
...
| repo_name                                                       | repo_id   |
+-----------------------------------------------------------------+-----------+
| dylanNicastro/cse220_hw5                                        | 788572524 |
| sarahbaalbaki/Bioinformatics                                    | 807189095 |
| AndreFug/OvingB                                                 | 807066591 |
| neharaut1432/Demogit                                            | 807264586 |
| Dipan-30/C-Assignment                                           | 807197084 |
| shlomiox/2024_withFiles_repoTest_public_1716915197926           | 807209487 |
| static-web-apps-testing-org/swad471958adcc14926bc1208ac10d6a5bb | 807334889 |
| SC136/NNDY                                                      | 804734249 |
| wisam2882/aa01--remastery-02-                                   | 807332485 |
| aliceohly/profile                                               | 806920289 |
+-----------------------------------------------------------------+-----------+
10 rows.
   Finished 1 model [1 succeeded] in 7.783 secs
...
| repo_id     | decimal(38, 0) |            |
+-------------+----------------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 1.694 secs
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  ...
  Compiling sdf_snowflake.cybersyn_tech_innovation.events_by_repo (./src/sdf_snowflake/cybersyn_tech_innovation/events_by_repo.sql)
   Finished 13 models [6 succeeded, 7 downloaded] in 1.531 secs
