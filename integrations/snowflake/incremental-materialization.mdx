...
| domain_id   | varchar   |            |
+-------------+-----------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 3.364 secs
...
| language                       | varchar        |            |
+--------------------------------+----------------+------------+
   Finished 3 models [1 succeeded, 2 downloaded] in 6.049 secs
...
+---------------------+----------------+------------+
   Finished 5 models [2 succeeded, 3 downloaded] in 8.594 secs
