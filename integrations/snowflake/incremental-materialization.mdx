...
| domain_id   | varchar   |            |
+-------------+-----------+------------+
   Finished 2 models [1 succeeded, 1 downloaded] in 3.411 secs
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  Compiling sdf_snowflake.staging.datafusion_push_events (aka sdf_snowflake.staging.datafusion_push_events)
...
| language                       | varchar        |            |
+--------------------------------+----------------+------------+
   Finished 3 models [1 succeeded, 2 downloaded] in 5.691 secs
...
Downloading tech__innovation_essentials.cybersyn.github_events (schema)
  Compiling sdf_snowflake.staging.datafusion_push_events (aka sdf_snowflake.staging.datafusion_push_events)
  Compiling sdf_snowflake.cybersyn_tech_innovation.top_datafusion_contributors (aka sdf_snowflake.cybersyn_tech_innovation.top_datafusion_contributors)
...
+---------------------+----------------+------------+
   Finished 5 models [2 succeeded, 3 downloaded] in 7.171 secs
