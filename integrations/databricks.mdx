...
<Steps>
  ...
  <Step title="Add generated Spark Config to Databricks Compute">
    ...
    In the **Cluster Configuration** page, click **Edit**. Note, if your cluster is currently running, you will need to restart it in order for changes to apply. In the section labeled **Spark**, add the spark configuration generated in the previous step to the **Spark Config** section. 
